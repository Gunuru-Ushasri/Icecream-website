...
const TeamSection = () => {
  return (
    <section>
        ...
        <h1 className='text-6xl text-white-500 text-center font-serif'>Team members</h1>
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-400">Our Team</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Our dedicated team crafts the finest ice creams with love and creativity. Bringing you delightful flavors, one scoop at a time</p>
    </div>
    <div className="flex flex-wrap -m-2">
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            <h2 className="text-gray-500 title-font font-medium">Henry Letham</h2>
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          ...
          <div className="flex-grow">
            <h2 className="text-gray-500 title-font font-medium">Oskar Blinde</h2>
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="assets/team4.jpg"/>
          <div className="flex-grow">
            <h2 className="text-gray-500 title-font font-medium">John Doe</h2>
      ...
      <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="assets/team5.avif"/>
          <div className="flex-grow">
            <h2 className="text-gray-500 title-font font-medium">Rodrigo Monchi</h2>
