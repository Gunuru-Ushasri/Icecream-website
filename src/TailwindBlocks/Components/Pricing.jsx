...
const Pricing = () => {
  return (
    <section>
        <section className="text-gray-600 body-font overflow-hidden bg-[var(--color-BgColor)] text-[var(--color-TextColor)]">
        <h1 className='text-6xl text-white-500 text-center font-serif'>Pricing</h1>
